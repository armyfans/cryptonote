...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x9c4db;
...
const char     CRYPTONOTE_NAME[]                             = "dimmcoin";
...
const int      P2P_DEFAULT_PORT                              = 27236;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 28236;
